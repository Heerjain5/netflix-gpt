  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <form
        ...
        className=" w-fullmd:w-3/12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-12 bg-black bg-opacity-70 text-white rounded-lg shadow-lg z-10"
      >
